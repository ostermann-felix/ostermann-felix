...
Junior Software Developer curious for new tech- and coding possibilities. Web technologies is my way to go. Knowledge with Cognigy AI low code.
...
[![My Skills](https://skillicons.dev/icons?i=js,angular,nextjs,react,nodejs,electron,html,css,tailwind,git)](https://skillicons.dev)
